      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="ios-card p-4">
          <div className="p-2 rounded-xl w-fit bg-[#8B1E3A]/10">
            <Building2 className="w-4 h-4 text-[#8B1E3A]" />
          </div>
              ...
              <div className="p-4">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="p-2.5 rounded-xl shrink-0 bg-[#8B1E3A]/10">
                      <Building2 className="w-4 h-4 text-[#8B1E3A]" />
                    </div>
                    ...
                    >
                      <div className="mt-3 pt-3 border-t border-border/50 grid grid-cols-2 sm:grid-cols-3 gap-2">
                        ...
                        {office.location && (office.location.lat !== 0 || office.location.lng !== 0) && (
                          <div className="p-2 rounded-lg bg-[#8B1E3A]/5 col-span-2 sm:col-span-3">
                    ...
                    >
                      <div className="mt-3 pt-3 border-t border-border/50">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                          <div className="p-2 rounded-lg bg-[#8B1E3A]/5">
                            <p className="text-[10px] text-[#8B1E3A]">إجمالي المعاملات</p>
              ...
              return (
                <div key={report.officeId} className="p-3 rounded-xl bg-muted/30">
                  ...
                  <div className="mt-2 pt-2 border-t border-border/30 flex items-center justify-between">
                    ...
                    <span className="text-xs font-bold text-[#8B1E3A]">{formatNumber(report.commissionEarned)} ر.ي</span>
                  </div>
                </div>
              );
            })}
