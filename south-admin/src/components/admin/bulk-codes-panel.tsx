            ...
            <Card className="admin-card border-0 shadow-none">
              <CardHeader>
                <CardTitle className="text-base flex items-center gap-2">
                  <FileCode className="w-5 h-5 text-[#8B1E3A]" /> إضافة أكواد بالجملة
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button onClick={handleSaveBatch} disabled={formSaving} className="w-full bg-[#7B1A30] hover:bg-[#5C1225]">
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="admin-card border-0 shadow-none">
          <CardContent className="p-4 text-center">
            <Package className="w-6 h-6 mx-auto mb-2 text-[#8B1E3A]" />
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgba(168,40,80,0.1)' }}>
                          <FileCode className="w-5 h-5 text-[#8B1E3A]" />
                        </div>
                        <div>
