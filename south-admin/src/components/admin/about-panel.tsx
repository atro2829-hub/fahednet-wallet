  ...
  return (
    <div className="space-y-6 max-w-[800px] mx-auto">
      ...
      <div className="ios-card p-6 text-center">
        <div className="w-20 h-20 mx-auto mb-4 rounded-3xl bg-gradient-to-br from-[#8B1E3A] to-[#4E0A19] flex items-center justify-center overflow-hidden shadow-xl shadow-[#8B1E3A]/20">
          <img
            src={APP_ICON_BASE64}
            alt="محفظة الجنوب"
      ...
      <motion.div
        ...
        className="ios-card-elevated p-6 bg-gradient-to-br from-[#8B1E3A]/5 to-purple-600/5 border border-[#8B1E3A]/10"
      >
        <div className="flex items-center gap-4">
          <div className="p-3 rounded-2xl bg-[#8B1E3A]/10">
            <Code className="w-6 h-6 text-[#8B1E3A]" />
          </div>
          <div>
            <p className="text-sm font-semibold text-foreground">تم التطوير بواسطة</p>
            <p className="text-lg font-bold text-[#8B1E3A] dark:text-[#A82850]">مؤسسة QTBM DEV</p>
        ...
        <div className="ios-card overflow-hidden">
          ...
          <div>
            ...
            <div className="ios-list-item gap-3">
              ...
              <span className="text-sm text-[#8B1E3A] font-medium">{adminUser.role === 'owner' ? 'المالك' : 'مدير'}</span>
            </div>
            <div className="ios-list-item gap-3">
              <div className="p-1.5 rounded-lg bg-muted/30">
      ...
      <div className="ios-card p-5">
        ...
        <div className="flex flex-wrap gap-2">
          {['Next.js 16', 'TypeScript', 'Firebase', 'Tailwind CSS', 'Capacitor', 'Zustand', 'Framer Motion'].map(tech => (
            <span key={tech} className="px-3 py-1.5 rounded-xl bg-[#8B1E3A]/10 text-[#8B1E3A] dark:text-[#A82850] text-xs font-medium">
              {tech}
            </span>
          ))}
        </div>
