    ...
    <div className="space-y-6 max-w-[1000px] mx-auto">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#8B1E3A] text-white text-sm font-medium shadow-lg shadow-[#8B1E3A]/25 active:scale-[0.98] transition-transform"
        >
            ...
            <div className="ios-card p-5 space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {permissionModules.map(mod => {
                    ...
                    return (
                      <div key={mod.id} className={cn("p-3 rounded-xl border", hasAny ? "border-[#8B1E3A]/30 bg-[#8B1E3A]/5" : "border-border/30 bg-muted/10")}>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button
                            ...
                            className={cn("text-xs px-2 py-1 rounded-lg", hasAny ? "bg-[#8B1E3A]/10 text-[#8B1E3A]" : "bg-muted/30 text-muted-foreground")}
                          >
                          ...
                          {(['canView', 'canCreate', 'canEdit', 'canDelete', 'canApprove'] as const).map(pk => {
                            ...
                            return (
                              <button
                                ...
                                className={cn("px-2.5 py-1 rounded-lg text-[11px] font-medium transition-all", perms[pk] ? "bg-[#8B1E3A] text-white" : "bg-muted/30 text-muted-foreground")}
                              >
                                {labels[pk]}
                              </button>
                            );
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-[#8B1E3A] text-white font-medium text-sm shadow-lg shadow-[#8B1E3A]/25 active:scale-[0.98] transition-transform disabled:opacity-50"
                >
                  إضافة الموظف
                </button>
                <button
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-[#8B1E3A]/10 text-[#8B1E3A] transition-colors"
                  ...
                  >
                    <div className="space-y-2">
                      {permissionModules.map(mod => {
                        ...
                        const hasAny = perms.canView || perms.canCreate || perms.canEdit || perms.canDelete || perms.canApprove;
                        return (
                          <div key={mod.id} className={cn("p-2.5 rounded-lg", hasAny ? "bg-[#8B1E3A]/5" : "bg-muted/10")}>
                              ...
                              {(['canView', 'canCreate', 'canEdit', 'canDelete', 'canApprove'] as const).map(pk => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={cn("px-2 py-0.5 rounded text-[10px] font-medium transition-all", perms[pk] ? "bg-[#8B1E3A] text-white" : "bg-muted/30 text-muted-foreground")}
                                  >
                                    {labels[pk]}
                                  </button>
                                );
